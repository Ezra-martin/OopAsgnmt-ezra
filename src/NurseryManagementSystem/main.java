        ...
        private static void enrollStudentInClass() {
            ...
            while (true) {
                ...
                if (!studentId.matches("^[a-zA-Z0-9]+$")) {
                    System.out.println("Error: Student ID must be alphanumeric.");
            ...
            while (true) {
                ...
                if (!studentName.matches("^[a-zA-Z ]+$")) {
                    System.out.println("Error: Student name must contain only letters and spaces.");
                } else {
                    break;
                }
            }
            ...
            while (true) {
                ...
                if (!guardianName.matches("^[a-zA-Z ]+$")) {
                    System.out.println("Error: Guardian name must contain only letters and spaces.");
                } else {
                    break;
                }
            }
